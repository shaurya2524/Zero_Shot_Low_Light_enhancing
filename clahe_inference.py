...
def reconstruct_from_components_structured(reflectance_path, shading_path, params, brightness_factor=10.0):
    """
...
def reconstruct_with_gamma_correction(reflectance_path, shading_path, gamma, brightness_factor=10.0):
    """
...
def reconstruct_from_components_simple(reflectance_path, shading_path, brightness_factor=10.0):
    """
...
def run_inference(input_dir, output_dir, params, brightness_factor, simple_gamma):
    """
    Processes all images, creating three versions: structured enhanced, gamma enhanced, and simple reconstructed.
    """
    input_path = Path(input_dir)
    base_output_path = Path(output_dir)
    
    # Create separate directories for the three types of output
    ...
    for r_path in tqdm(reflectance_files, desc="Processing images", ncols=100):
        ...
        # 1. Generate and save the STRUCTURE-AWARE ENHANCED image
        ...
        # 2. Generate and save the simple GAMMA-ENHANCED image
        ...
        # 3. Generate and save the simple RECONSTRUCTED image
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float, 
        default=10.0, 
        help=" factor to apply to all final images. Default is 10.0."
    )
    ...
    run_inference(args.input_dir, args.output_dir, structured_params, args.brightness, args.simple_gamma)
